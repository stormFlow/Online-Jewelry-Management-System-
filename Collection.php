												...
												<ul class="list-inline text-right">
													...
													<div id="sortBox" class="control-container dropdown-menu">
														<ul id="sortForm" class="list-unstyled option-set text-left list-styled" data-option-key="sortBy">
                                                                                                                    <a href="<?php if(isset($_GET['id'])&&!empty($_GET['id'])){echo "Collection.php?view=manul&id=".$_GET['id']."";}else{ echo "Collection.php?view=manul";} ?>"><li class="sort" data-option-value="manual">Featured</li></a>
															<a href="<?php if(isset($_GET['id'])&&!empty($_GET['id'])){echo "Collection.php?view=aes&id=".$_GET['id']."";}else{ echo "Collection.php?view=aes";} ?>"><li class="sort" data-option-value="price-ascending" data-order="asc">Price: Low to High</li></a>
															<a href="<?php if(isset($_GET['id'])&&!empty($_GET['id'])){echo "Collection.php?view=des&id=".$_GET['id']."";}else{ echo "Collection.php?view=des";} ?>"><li class="sort" data-option-value="price-descending" data-order="desc">Price: High to Low</li></a>
										...
										<div id="sandBox-wrapper" class="group-product-item row collection-full">
											<ul id="sandBox" class="list-unstyled">
                                                                                            ...
                                                                                            if(isset($_GET['view'])&&!empty($_GET['view']))
                                                                                            {
                                                                                                ...
                                                                                                {
                                                                                                     $q="select * from tbl_product_details order by Unitprice;";
                                                                                                }
                                                                                                else if($_GET['view']=="des")
                                                                                                {
                                                                                                     $q="select * from tbl_product_details order by Unitprice desc;";
                                                                                                }
                                                                                                else
                                                                                                {
                                                                                                    //other
