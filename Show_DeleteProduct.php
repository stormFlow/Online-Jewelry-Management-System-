            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="pvr-wrapper">
                        <div class="pvr-box">
                            ...
                            <form method="post" enctype="multipart/form-data" action="Query_DelProduct.php">
                                <fieldset>
                                    <div class="form-group">
                                        <label for="exampleInputEmail4">Product Name</label>
                                        <input type="text" readonly="true" name="pname" class="form-control" id="exampleInputEmail4" value="<?php echo $r['Product_name']; ?>"  placeholder="Enter Product Name" />
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputPassword4">Weight</label>
                                        <input type="text" readonly="true" class="form-control" id="exampleInputPassword4" value="<?php echo $r['Weight']; ?>"  name="pweight" placeholder="Enter Product Weight" />
                                    </div>
                                     ...
                                     <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="exampleInputPassword4" value="<?php echo $r['Unitprice']; ?>"
                                               name="pprice" readonly="true"    placeholder="Enter Product Price">
                                    </div>
                                         <div class="form-group">   
                                        ...
                                        <input type="number" class="form-control" id="exampleInputPassword4" value="<?php echo $r['Quentity']; ?>"
                                               name="pqty" readonly="true"    placeholder="Enter Product Price">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputPassword4">Product Material</label>
                                        <input type="text" class="form-control" readonly="true" id="exampleInputPassword4" value="<?php echo $r['Product_material']; ?>"
                                     ...
                                     <div class="form-group">
                                        ...
                                        <select class="form-control" readonly="true" name="pcategory">
                                            <?php 
                                           
 
             $q="select Category_id,Category_name from tbl_category_details where Category_id='".$r['Category_id']."';";
             ...
             while($row=  mysqli_fetch_array($q1))
             {
                        ...
                        <div class="form-group">
                                        ...
                                        <img src="<?php echo $r['Imagepath']; ?>" readonly="true" class="form-control img-responsive"/>
                                        
                        </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail4">Product Description</label>
                                        <textarea rows="3" cols="10" name="pdesc" readonly="true" class="form-control" placeholder="Enter Product Description"><?php echo $r['Description']; ?></textarea>
                                    </div>
                                    <input type="submit" value="Conform Delete" class="btn btn-purple m-r-5">
