...
if(!isset($_SESSION['UserID']))
{
 ...
 $query ="SELECT tbl_product_details.*,tbl_order_details.*,tbl_registration_details.* FROM tbl_Product_details,tbl_registration_details,tbl_order_details where tbl_order_details.UserID=tbl_registration_details.UserID and tbl_product_details.Product_id=tbl_order_details.Product_id";  
 $result = mysqli_query($connect, $query)or die(print_r($connect));  
 ?>  
<?php
 if(isset($_GET['msg'])&&!empty($_GET['msg']))
        ...
        ?>
        <script>
            $.bootstrapGrowl('Order deleted successfully',{
            type: 'success',
            delay: 2000,
        });
        </script>
 ...
 if(isset($_GET['error'])&&!empty($_GET['error']))
        ...
        ?>
        <script>
            $.bootstrapGrowl('Problem for deleting order.',{
            type: 'danger',
            delay: 2000,
        });
        </script>
                     ...
                     <table id="employee_data" class="table table-hover table-responsive table-bordered">  
                         <thead style="background:lightslategray">  
                          ...
                          {  
                              ?> 
                               <tr>  
                                   <td><img src="<?php echo $row['Imagepath']; ?>" class="img-responsive col-lg-4" alt="No image set"></td>
                                    ...
                                    <td><?php echo $row["Username"];?></td>
                                        ...
                                        $res = mysqli_query($connect, $q);
                                         while($r= mysqli_fetch_array($res))  
                                         {
                                           ...
                                           ?>
                                           <td><a href="Query_DelOrderdatatable.php?id=<?php echo $row['OrderID']; ?>"><span class="fa fa-remove"</a></td>   
